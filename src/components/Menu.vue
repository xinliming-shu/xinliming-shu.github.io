...
<template>
    <a-layout class="layout-menu">
        ...
        <div class="header" align="center">
            ...
            <span style="font-size:25px;font-family: 微软雅黑" >辛立明</span>
            <span style="font-size: 20px;font-family: 黑体">教授，博导/硕导</span>
            <span style="font-size: 15px;font-family: 'Times New Roman'">xinliming@shu.edu.cn</span>
        </div>
        <!-- 菜单 -->
        <a-layout-content class="menu">
            <a-menu style="font-size: 17px">
                <!-- 根据配置动态模块的内容和顺序 -->
